    ...
    <div class="container">
      <div class="col-md-12">
        <div class="appnav navbar-expand-lg" id="student_nav">
          ...
          <div>
          <c:if test="${srEmail  != null || hoEmail  != null }">
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/SeekerServlet/edit"
              class="profile_link" style="float: left; font-weight: bold;font-size: 14px;" id="navbarDropdown"
              aria-expanded="false">
              <i class="fas fa-file-alt"></i>&nbsp;Seeker Profile
            </a>
            </c:if> 
               <c:if test="${adEmail  != null || hoEmail  != null }">
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/AdminServlet/Donor"
              class="profile_link" style="float: left; font-weight: bold;font-size: 14px;" id="navbarDropdown"
              aria-expanded="false">
              <i class="fas fa-file-alt"></i>&nbsp;Donor
            </a>
            </c:if> 
             <c:if test="${adEmail  != null || hoEmail  != null }">
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/AdminServlet/Seeker"
              class="profile_link" style="float: left; font-weight: bold;font-size: 14px;" id="navbarDropdown"
              aria-expanded="false">
              <i class="fas fa-file-alt"></i>&nbsp;Seeker 
            </a>
            </c:if> 
             <c:if test="${adEmail  != null || hoEmail  != null }">
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/AdminServlet/request"
              class="profile_link" style="float: left; font-weight: bold;font-size: 14px;" id="navbarDropdown"
              aria-expanded="false">
            ...
            <a class="nav-link dropdown-toggle" href="${pageContext.request.contextPath}/DonorServlet/edit"
              class="profile_link" style="float: left; font-weight: bold;font-size: 14px;" id="navbarDropdown"
              aria-expanded="false">
              <i class="fas fa-file-alt"></i>&nbsp;Donor Profile
            </a>
            </c:if>
